...
var util = require('util'), controllerGenerator = require('./controller.generator'), htmlGenerator = require('./html.generator'), inflections = require('underscore.inflections'), s = require('underscore.string'), _ = require('lodash'), mkdirp = require('mkdirp'), yeoman = require('yeoman-generator'), fs = require('fs');
